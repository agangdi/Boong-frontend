      ...
      {showClaimPopup && !showClaimModal && (
        <StyledClaimPopup gap="md">
          ...
          <AutoColumn style={{ zIndex: 10 }} justify="center">
            <ButtonPrimary padding="8px" borderRadius="0px" width={'fit-content'} onClick={toggleSelfClaimModal}>
