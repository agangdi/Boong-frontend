...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@teaswap/uniswap-sdk'
...
// }: RouteComponentProps<{ currencyIdA?: string; currencyIdB?: string }>) {
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        navigate(`/add/${currencyIdA ? currencyIdA : 'BNB'}/${newCurrencyIdB}`)
      }
    },
  ...
  const isCreate = navigate.name.includes('/create')
